...
<?php
		...
		$tag[$this->settings['label']] =  '<span class="billmate_invoice"><span class="col1"><b>'.__('Invoice Information','shopp-billmate-invoice').'</b><input type="text" id="pno" name="billmate[pno]" class="required" value="'.$this->Order->pno.'" /><label for="pno">'.__('Personal Number', 'shopp-billmate-invoice').'</label></span><span class="col2" style="width:134px"><img src="'.content_url().'/shopp-addons/gateways/'.($this->module).'/images/bm_faktura_l.png"/></span><span style="width: 178px;height:99px;"><span style="padding: 0 !important;width: 264px;">'.__('Billmate Invoice - Pay in 14 days','shopp-billmate-invoice').'</span><span><a id="terms">'.__('Terms of invoice','shopp-billmate-invoice').'</a></span></span><span style="min-width:425px;max-width: 480px;padding-right:none;"><input type="checkbox" checked="checked" name="billmate[phone]" id="billmatephone" class="required" value="on" style="float: none;"><label for="billmatephone" style="float: right;width:95%" class="confirmlabel">'.__('My email address is correct and can be used for invoicing purposes.', 'shopp-billmate-invoice').'</label></span><input type="image" src="'.content_url().'/shopp-addons/gateways/BillmateInvoice/images/betala_knapp.gif" class="checkout-button" value="Submit Order" id="checkout-button" name="process"></span><style type="text/css">
