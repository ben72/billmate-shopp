...
function get_billmate_version(){
	...
	echo '<h1> billmate version 1.14 </h1>';
...
function isEqual($tstring1, $tstring2 ){
	$string1 = explode(" ", utf8_strtolower( (string)$tstring1 ) );
	$string2 = explode(" ", utf8_strtolower( (string)$tstring2 ) );
